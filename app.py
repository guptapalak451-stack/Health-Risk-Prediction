...
def get_db():
    return mysql.connector.connect(
        ...
        password="PalakGupta@0610", database="heart_app"
    )
      ...
      <div style="max-width:560px;margin:0 auto;background:#0B1E38;
        ...
        <div style="padding:16px 36px;border-top:1px solid rgba(255,255,255,.06);text-align:center;">
          <p style="font-size:11px;color:#4A6A88;margin:0;">
            CardioAI · Built by PalakGupta · Not a substitute for medical advice
          </p>
        </div>
      </div>
    </div>
...
st.markdown(
    ...
    "<span style='font-size:12px;color:#4A6A88;font-weight:400'> · Built by PalakGupta</span></span>"
    "<p style='font-size:11px;color:#4A6A88;margin:0'>"
